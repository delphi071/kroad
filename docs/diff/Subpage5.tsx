  ...
  return (
    ...
    >
      ...
      <div className="flex gap-[60px] items-center justify-end w-full">
        ...
        >
          <span className="font-pretendard font-bold leading-[1.5] text-grayscale-900 tracking-[-0.96px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.common.submit}</span>
        </button>
      </div>
    </div>
  );
    ...
    <div className="absolute flex gap-[60px] items-start" style={{ left: 200, top: F(1387), width: 1534 }}>
      ...
      <div className="flex flex-1 flex-col gap-[60px] items-end min-w-px">
        ...
        <button
          ...
          style={{ borderTopLeftRadius: 20, borderBottomRightRadius: 20, width: 224 }}
        >
          <span className="font-pretendard font-bold leading-[1.5] text-grayscale-900 tracking-[-0.96px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.common.send}</span>
        </button>
      </div>
    </div>
  );
