      ...
      >
        ...
        <div className="hidden lg:block">
          ...
          {!collapsed && (
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/figma/hero-scroll-chevron.png" alt="" aria-hidden className="absolute" style={{ left: "50%", top: "calc(100% * 50 / 244)", transform: "translateX(-50%)", width: "calc(100% * 100 / 516)", height: "calc(100% * 100 / 244)" }} />
