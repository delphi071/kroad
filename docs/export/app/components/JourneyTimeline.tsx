                  ...
                  {item.events.map((ev, j) => (
                    <div key={j} className="flex items-start gap-[10px]">
                      ...
                      <div className="flex-1">
                        <p className="font-pretendard text-grayscale-700 text-[14px] font-bold leading-normal tracking-[-0.7px]">
                          {ev.title}
                        </p>
                        {ev.desc && (
                          <p className="font-pretendard text-grayscale-600 text-[12px] leading-normal tracking-[-0.6px] mt-[3px]">
                            {ev.desc}
                          </p>
                        )}
                      </div>
