...
const F2 = (figmaY: number) => figmaY - 713;
const FOOTER_HEIGHT = 675;
const SUBPAGE_HEIGHT = 8780 - 713 + FOOTER_HEIGHT; // 8742
  ...
  return (
    <div className="bg-grayscale-100">
      ...
      <div className="lg:hidden bg-grayscale-100 flex flex-col items-center gap-[83px] px-[20px] py-[64px]">
        ...
        <div className="flex flex-col items-center gap-[24px] text-center font-pretendard text-grayscale-900 tracking-[-1.3px] w-full">
          <div>
            {t.subpage2.bigHeadingRegular.map((line, i) => (
              <p key={i} className="text-[40px] leading-[1.2] break-keep">{line}</p>
            ))}
          </div>
          <div>
            {t.subpage2.bigHeadingBold.map((line, i) => (
              <p key={i} className="text-[40px] font-bold leading-[1.2] break-keep">{line}</p>
            ))}
          </div>
        </div>
        ...
        <div className="relative w-full" style={{ height: 1070 }}>
          ...
          <div className="absolute" style={{ left: 28, top: 920, width: 295 }}>
            <div className="font-pretendard text-grayscale-900 text-[24px] font-bold tracking-[-0.96px] leading-normal text-center">
        ...
        <div className={`flex flex-col items-center gap-[46px] font-pretendard ${lang === "en" ? "" : "whitespace-nowrap"}`}>
          <div className="flex flex-col items-center gap-[18px]">
            <p className="text-primary text-[24px] font-bold tracking-[-0.96px] leading-normal">{SECTIONS[0].enHook}</p>
          ...
          <div className="text-grayscale-900 text-[24px] tracking-[-0.96px] leading-normal text-center">
        ...
        <div className={`flex flex-col items-center gap-[46px] font-pretendard ${lang === "en" ? "" : "whitespace-nowrap"}`}>
          <div className="flex flex-col items-center gap-[18px]">
            <p className="text-primary text-[24px] font-bold tracking-[-0.96px] leading-normal">{SECTIONS[1].enHook}</p>
        ...
        <div className={`flex flex-col items-center gap-[46px] font-pretendard ${lang === "en" ? "" : "whitespace-nowrap"}`}>
          <div className="flex flex-col items-center gap-[18px]">
            <p className="text-primary text-[24px] font-bold tracking-[-0.96px] leading-normal">{SECTIONS[2].enHook}</p>
      ...
      >
        ...
        >
          ...
          <div
            className="absolute"
            style={{ left: 0, top: F2(1327), width: 1590, height: 1401 }}
            aria-hidden
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <div
            className="absolute"
            style={{ left: 544, top: F2(2979), width: 1002, height: 6144 }}
            aria-hidden
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          >
            ...
            <p className={`font-pretendard text-grayscale-900 text-[32px] tracking-[-0.72px] leading-[1.3] ${lang === "en" ? "" : "whitespace-nowrap"}`}>
          ...
          {/* Right intro text */}
          <div
            className={`absolute font-pretendard text-grayscale-900 text-[32px] tracking-[-0.72px] leading-[1.3] text-right ${lang === "en" ? "" : "whitespace-nowrap"}`}
          ...
          {/* Tagline */}
          <div
            className={`absolute font-pretendard text-grayscale-900 ${lang === "en" ? "text-[40px]" : "text-[54px]"} font-bold tracking-[-1.56px] leading-[1.3] ${lang === "en" ? "" : "whitespace-nowrap"}`}
          ...
          <p
            className="absolute font-pretendard text-primary text-[54px] font-bold leading-[1.3] tracking-[-1.56px] whitespace-nowrap"
          ...
          <div
            className={`absolute z-10 font-pretendard text-grayscale-900 ${lang === "en" ? "text-[32px]" : "text-[44px]"} font-bold tracking-[-1.3px] ${lang === "en" ? "" : "whitespace-nowrap"}`}
          ...
          <div
            className={`absolute font-pretendard text-grayscale-700 text-[20px] tracking-[-0.24px] ${lang === "en" ? "" : "whitespace-nowrap"}`}
