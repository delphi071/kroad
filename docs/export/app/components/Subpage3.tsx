      ...
      <div className="flex flex-col gap-[20px] items-start w-full">
        {item.blocks.map((b, i) => (
          <div key={i} className="flex flex-col gap-[10px] items-start w-full">
            ...
            <p className="font-pretendard leading-normal text-grayscale-700 tracking-[-0.32px] whitespace-pre-wrap" style={{ fontSize: 16 }}>{b.subBody}</p>
          </div>
        ))}
      </div>
      {hasStoreButton && (
        ...
        >
          <span className="font-pretendard font-bold leading-normal text-white tracking-[-0.32px] whitespace-nowrap" style={{ fontSize: 16 }}>{t.common.goShop}</span>
        ...
        <div className="w-[480px] shrink-0 flex flex-col gap-[36px] items-start">
          {active.blocks.map((b, i) => (
            <div key={i} className="flex flex-col gap-[13px] items-start w-full">
              ...
              <p className="font-pretendard leading-normal text-grayscale-700 tracking-[-0.4px] whitespace-pre-wrap" style={{ fontSize: 20 }}>{b.subBody}</p>
            </div>
          ))}
        </div>
      ...
      <div className="flex items-start w-full">
        ...
        {active.cta && (
          <a
            ...
            style={{ borderTopLeftRadius: 20, borderBottomRightRadius: 20 }}
          >
            <span className="font-pretendard font-bold leading-normal text-white tracking-[-0.32px] whitespace-nowrap" style={{ fontSize: 16 }}>{active.cta.label}</span>
          </a>
        )}
        */}
        ...
        <a
          ...
          style={{ borderTopLeftRadius: 20, borderBottomRightRadius: 20 }}
        >
          <span className="font-pretendard font-bold leading-normal text-primary tracking-[-0.32px] whitespace-nowrap" style={{ fontSize: 16 }}>신청하기</span>
...
function PCTextColumn({ section }: { section: SectionData }) {
  return (
    <div className="flex flex-col gap-[40px] items-start">
      ...
      <div className="flex flex-col gap-[16px] items-start font-pretendard leading-normal text-grayscale-700 tracking-[-0.4px]" style={{ fontSize: 20 }}>
        {section.body.map((p, i) => (
          <p key={i} className="leading-normal" style={{ marginBottom: 0 }}>{p}</p>
        ))}
      </div>
      {section.subHeading && section.subBody && (
        <div className="flex flex-col gap-[14px] items-start mt-[20px]">
          ...
          <div className="flex flex-col gap-[12px] items-start font-pretendard leading-normal text-grayscale-700 tracking-[-0.4px]" style={{ fontSize: 20 }}>
      ...
      {section.cta && (
        <a
          ...
          style={{ borderTopLeftRadius: 20, borderBottomRightRadius: 20 }}
        >
          <span className="font-pretendard font-bold leading-normal text-white tracking-[-0.32px] whitespace-nowrap" style={{ fontSize: 16 }}>{section.cta.label}</span>
...
function MobileSection({ section }: { section: SectionData }) {
  return (
    <div className="flex flex-col gap-[32px] w-full">
      ...
      <div className="flex flex-col gap-[14px] items-start font-pretendard leading-normal text-grayscale-700 tracking-[-0.32px]" style={{ fontSize: 16 }}>
        {section.body.map((p, i) => (
          <p key={i} className="leading-normal" style={{ marginBottom: 0 }}>{p}</p>
        ))}
      </div>
      ...
      {section.subHeading && section.subBody && (
        <div className="flex flex-col gap-[12px] items-start">
          ...
          <div className="flex flex-col gap-[10px] items-start font-pretendard leading-normal text-grayscale-700 tracking-[-0.32px]" style={{ fontSize: 16 }}>
            {section.subBody.map((p, i) => (
              <p key={i} className="leading-normal" style={{ marginBottom: 0 }}>{p}</p>
            ))}
          </div>
      ...
      {section.cta && (
        ...
        >
          <span className="font-pretendard font-bold leading-normal text-white tracking-[-0.32px] whitespace-nowrap" style={{ fontSize: 14 }}>{section.cta.label}</span>
    ...
    <div ref={rootRef} className="bg-grayscale-100">
      ...
      <div className="lg:hidden bg-grayscale-100 flex flex-col items-center gap-[80px] px-[20px] py-[84px]">
        <div className="flex flex-col gap-[14px] items-center w-full text-center">
          ...
          {lang === "ko" ? (
            <>
              <div className="font-pretendard leading-[1.2] text-grayscale-900 tracking-[-1.5px]" style={{ fontSize: 36 }}>
                <p>길의 본질부터 일상의</p>
                <p>가치까지,</p>
              </div>
              <div className="font-pretendard font-bold leading-[1.2] text-grayscale-900 tracking-[-1.5px]" style={{ fontSize: 36 }}>
                <p>통합적인 솔루션을</p>
                <p>제안합니다.</p>
              </div>
            </>
      ...
      <div className="hidden lg:block relative z-0 w-full overflow-hidden bg-grayscale-100" style={{ height: `calc(100vw * ${contentHeight} / 1920)` }}>
        <div className="origin-top-left" style={{ width: 1920, transform: "scale(calc(100vw / 1920px))", transformOrigin: "top left" }}>
          <div ref={innerRef} className="flex flex-col" style={{ width: 1920 }}>
            ...
            <div className="px-[200px] pt-[60px] pb-[180px] flex flex-col gap-[42px] items-start">
              ...
              <div className="font-pretendard text-grayscale-900 tracking-[-1px]">
                <p className="leading-[1.1] font-normal" style={{ fontSize: 70 }}>{t.subpage3.headlineRegular}</p>
                <p className="leading-[1.1] font-bold" style={{ fontSize: 70 }}>{t.subpage3.headlineBold}</p>
              </div>
            </div>

            {/* 4 sections — all carousels. pb-[320] gives wider space before footer. */}
            <div className="px-[200px] pb-[240px] flex flex-col gap-[360px]">
