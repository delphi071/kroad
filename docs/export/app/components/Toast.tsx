  ...
  return (
    ...
    >
      {toasts.map((t) => (
        <div
          key={t.id}
          className="font-pretendard rounded-[8px] bg-black/85 px-[40px] py-[14px] text-[15px] leading-normal tracking-[-0.3px] text-white shadow-lg backdrop-blur-sm transition-all duration-300"
          style={{
