...
const F  = (figmaY: number) => figmaY - 713;   // TOP section
    ...
    <div ref={rootRef} className="bg-grayscale-100">
            ...
            <div key={i} className="flex flex-col gap-[16px] w-full">
              ...
              <div className="font-pretendard text-primary text-[12px] tracking-[-0.6px] text-center">
                {t.subpage1.mission.cards[i].map((line, j) => (
                  <p key={j} className="leading-normal">
                    {line}
                  </p>
                ))}
              </div>
          ...
          {lang === "ko" ? (
            <>
              <p className="text-[46px] font-bold leading-[1.2] text-grayscale-900">
                <span className="text-primary">걷는 길</span>이
              </p>
              ...
              <p className="text-grayscale-900 text-[46px] font-bold leading-[1.2]">걷기 문화의 중심</p>
            </>
          ) : (
        ...
        >
          ...
          >
            {t.subpage1.mission.bigRegular.map((line, i) => (
              <p key={`r${i}`} className={`${lang === "en" ? "text-[70px]" : "text-[88px]"} font-normal leading-[1.1]`}>{line}</p>
            ))}
            {t.subpage1.mission.bigBold.map((line, i) => (
              <p key={`b${i}`} className={`${lang === "en" ? "text-[70px]" : "text-[88px]"} font-bold leading-[1.1]`}>{line}</p>
            ))}
          </div>

          <p
            className="absolute font-serif text-[110px] leading-none"
          ...
          <div
            className="absolute font-pretendard text-[32px] tracking-[-0.72px] whitespace-nowrap"
          ...
          >
            {[
              ...
              <div key={i} className="flex flex-1 flex-col items-start gap-[98px]">
                ...
                <div className="w-full text-center font-pretendard text-[26px] tracking-[-0.9px] text-primary">
                  {t.subpage1.mission.cards[i].map((line, j) => (
          ...
          >
            {lang === "ko" ? (
              <>
                <div className="flex items-center justify-center gap-[20px] font-pretendard text-[110px] font-bold leading-[1.2] tracking-[-7.44px]">
              ...
              <>
                {t.subpage1.vision.tagline.map((line, i) => (
                  <div key={i} className="font-pretendard text-[70px] font-bold leading-[1.2] tracking-[-3.2px] text-center">
                    {line}
                  </div>
                ))}
              </>
          ...
          <div
            className="absolute -translate-x-1/2 bg-primary"
            style={{ left: "50%", top: F(4451), width: 32, height: 466 }}
            aria-hidden
          />
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <p
            className={`absolute font-pretendard ${lang === "en" ? "text-[70px]" : "text-[88px]"} font-bold leading-[1.1] tracking-[-1px]`}
          ...
          <div
            className="absolute font-pretendard text-[32px] leading-[1.3] tracking-[-0.72px] whitespace-nowrap"
      ...
      >
        ...
        >
          ...
          >
            <p className="font-pretendard text-[32px] font-extrabold leading-[1.1] tracking-[-0.36px] text-white">
          ...
          >
            {t.subpage1.people.teams.map((team, i) => (
              ...
              >
                <p className={`font-pretendard ${lang === "en" ? "text-[20px]" : "text-[26px]"} font-bold leading-normal tracking-[-1.2px] text-primary text-center`}>
                  {team}
                </p>
              </div>
            ))}
            ...
            {t.subpage1.people.teamItems.map((items, idx) => (
              ...
              >
                {items.map((item, j) => (
                  <p
                    key={j}
                    className={`font-pretendard ${lang === "en" ? "text-[20px]" : "text-[26px]"} leading-[1.3] tracking-[-0.9px] text-primary text-center`}
                  >
                    {item}
                  </p>
                ))}
          ...
          <div
            ...
            style={{ left: 200, top: FC(12064), width: 1400, height: 610 }}
          >
            {/* 지도 일러스트 */}
            ...
            <div className="flex h-[610px] w-[706px] shrink-0 flex-col justify-between px-[50px] py-[70px]">
              ...
              <div className="flex flex-col gap-[34px]">
                <div className="flex items-start gap-[24px]">
                  ...
                  <div className={`font-pretendard ${lang === "en" ? "text-[18px]" : "text-[20px]"} leading-[1.3] tracking-[-0.24px]`}>
                ...
                <div className="flex items-center gap-[24px]">
                  <div className="size-[40px] shrink-0 rounded-full border border-solid border-primary" />
                  <p className="font-pretendard text-[20px] leading-[1.3] tracking-[-0.24px] whitespace-nowrap">
          ...
          {/* ============= FOOTER ============= */}
          <div className="absolute" style={{ left: 0, top: FC(12825), width: 1920 }}>
            <Footer />
          </div>
        </div>
      </div>
      ...
      <div className="lg:hidden flex flex-col items-center gap-[83px] px-[20px] py-[64px]">
        ...
        {/* People big text */}
        <p className={`text-center font-pretendard text-grayscale-900 ${lang === "en" ? "text-[32px]" : "text-[50px]"} font-bold leading-[1.2] tracking-[-1.3px] break-keep`}>
          {t.subpage1.people.headline}
        </p>
          ...
          >
            ...
            >
              {t.subpage1.people.teams.map((team, i) => (
                ...
                >
                  <p className={`font-pretendard text-primary ${lang === "en" ? "text-[8px]" : "text-[10px]"} font-bold leading-normal tracking-[-0.4px] text-center`}>
                    {team}
                  </p>
                </div>
              ))}
        ...
        <div className="flex flex-col items-start gap-[32px] w-full">
          ...
          <div className="bg-white relative w-full aspect-[362/318] overflow-hidden">
            ...
            {/* Labels */}
            <p
              className="absolute font-pretendard text-grayscale-900 text-[12px] text-center tracking-[-0.6px] leading-normal whitespace-nowrap"
              style={{ left: "46.47%", top: "41.42%", transform: "translateX(-50%)" }}
            >
              {t.subpage1.location.samgakji.map((line, i) => (<span key={i}>{i > 0 && <br />}{line}</span>))}
            </p>
            <p
              className="absolute font-pretendard text-grayscale-900 text-[12px] tracking-[-0.6px] leading-normal whitespace-nowrap"
              style={{
                left: "80.45%",
                top: "12.71%",
          ...
          <div className="flex flex-col items-start gap-[20px]">
            <div className="flex items-start gap-[12px]">
              ...
              <div className="font-pretendard text-grayscale-900 text-[14px] tracking-[-0.7px] leading-normal">
                {t.subpage1.location.address.map((line, i) => (
                  <p key={i}>{line}</p>
                ))}
              </div>
            ...
            <div className="flex items-center gap-[12px]">
              ...
              <p className="font-pretendard text-grayscale-900 text-[14px] tracking-[-0.7px] leading-normal whitespace-nowrap">
                {t.subpage1.location.phone}
              </p>
            </div>
            <div className="flex items-center gap-[12px]">
      ...
      <div className="lg:hidden bg-grayscale-100 flex flex-col items-center gap-[40px] px-[20px] py-[64px]">
                  ...
                  <div className="flex flex-col items-center gap-[6px]">
                    {col.items.map((item, itemIdx) => (
                      <a
                        ...
                        className="font-pretendard text-grayscale-600 text-[12px] leading-normal tracking-[-0.6px] text-center hover:text-primary"
        ...
        <div className="flex flex-col items-center gap-[6px] text-center">
          ...
          <p className="font-pretendard text-grayscale-600 text-[10px] font-bold leading-normal">
