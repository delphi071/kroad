  ...
  return (
    <div className="lg:hidden bg-grayscale-100 flex flex-col items-center gap-[40px] px-[20px] py-[64px]">
            ...
            <div key={col.title} className="flex flex-col items-center gap-[10px] w-[100px]">
              ...
              <div className="flex flex-col items-center gap-[6px]">
                {col.items.map((item, itemIdx) => (
                  <a key={item} href={getSubHref(colIdx, itemIdx)} className="font-pretendard text-grayscale-600 text-[12px] leading-normal tracking-[-0.6px] text-center hover:text-primary" style={{ whiteSpace: "pre-line" }}>{dictCol.items[itemIdx] || item}</a>
                ))}
              </div>
            </div>
            );
        ...
        <div className="flex items-start justify-between w-full">
          {NAV_COLS.slice(3, 6).map((col, colIdx) => {
            ...
            <div key={col.title} className="flex flex-col items-center gap-[10px] w-[100px]">
              ...
              <div className="flex flex-col items-center gap-[6px]">
                {col.items.map((item, itemIdx) => (
                  <a key={item} href={getSubHref(colIdx + 3, itemIdx)} className="font-pretendard text-grayscale-600 text-[12px] leading-normal tracking-[-0.6px] text-center hover:text-primary" style={{ whiteSpace: "pre-line" }}>{dictCol.items[itemIdx] || item}</a>
                ))}
              </div>
            </div>
            );
      ...
      <div className="flex flex-col items-center gap-[6px] text-center">
        ...
        <p className="font-pretendard text-grayscale-600 text-[10px] font-bold leading-normal">서울특별시 용산구 한강대로52길 25-8, DB Tower 402호</p>
        <p className="font-pretendard text-grayscale-600 text-[10px] font-bold leading-none">대표전화 : 02-6013-6610</p>
    ...
    <>
      {items.map((it) => {
        ...
        return active ? (
          ...
          >
            {lang === "ko" && (
              <p className="font-montserrat font-bold leading-none tracking-[-1.28px]" style={{ fontSize: 28 }}>{subLabel}</p>
            )}
            <p className="font-pretendard font-bold leading-[1.3] tracking-[-1.56px] whitespace-nowrap" style={{ fontSize: lang === "en" ? 40 : 54 }}>{mainLabel}</p>
          </button>
        ) : (
          <button
            key={it.id}
            ...
            style={{ left: it.left, top: F(1199), fontSize: lang === "en" ? 40 : 54 }}
          >
            {mainLabel}
          </button>
        );
...
function PCHeader() {
  ...
  return (
    <div className="absolute" style={{ left: 200, top: F(773), width: 1500 }}>
      {lang === "ko" ? (
        <>
          <p className="font-pretendard leading-[1.1] text-grayscale-900" style={{ fontSize: 88, letterSpacing: "-1px" }}>알리고 나누어</p>
          <p className="font-pretendard leading-[1.1] text-grayscale-900 font-bold" style={{ fontSize: 88, letterSpacing: "-1px" }}>길을 더 풍성하게 합니다.</p>
        </>
      ) : (
        <>
          <p className="font-pretendard leading-[1.1] text-grayscale-900" style={{ fontSize: 64, letterSpacing: "-1px" }}>Sharing stories,</p>
          <p className="font-pretendard leading-[1.1] text-grayscale-900 font-bold" style={{ fontSize: 64, letterSpacing: "-1px" }}>enriching every trail.</p>
        </>
      )}
    </div>
  );
...
function MobileHeader() {
  ...
  return (
    <div className="font-pretendard text-grayscale-900 w-full" style={{ letterSpacing: "-0.96px" }}>
      {lang === "ko" ? (
        <>
          <p className="leading-normal" style={{ fontSize: 24 }}>알리고 나누어</p>
          <p className="leading-normal font-bold" style={{ fontSize: 24 }}>길을 더 풍성하게 합니다.</p>
        </>
      ) : (
        <>
          <p className="leading-normal" style={{ fontSize: 22 }}>Sharing stories,</p>
          <p className="leading-normal font-bold" style={{ fontSize: 22 }}>enriching every trail.</p>
        </>
      )}
    </div>
  );
      ...
      {items.map((it) => {
        ...
        return active ? (
          ...
          >
            ...
            <p className="font-pretendard font-bold leading-normal tracking-[-0.96px] whitespace-nowrap" style={{ fontSize: 24 }}>{it.korean}</p>
          </button>
        ) : (
          <button
            key={it.id}
            type="button"
            onClick={() => onSelect(it.id)}
            className="font-pretendard font-bold leading-normal tracking-[-0.96px] whitespace-nowrap text-grayscale-200 cursor-pointer hover:text-grayscale-400"
            style={{ fontSize: 24 }}
          >
            {it.korean}
          </button>
      ...
      <div className="absolute flex flex-col items-start whitespace-nowrap" style={{ left: 200, top: F(1387), width: 1520 }}>
        {NOTICES.map((n) => (
          <button
            ...
            style={{ height: 121 }}
          >
            <p className="font-montserrat font-bold leading-none text-grayscale-600 shrink-0" style={{ fontSize: 18 }}>{n.date}</p>
            <p className="font-pretendard font-bold leading-[1.3] text-grayscale-900 tracking-[-0.72px]" style={{ fontSize: 32 }}>{n.title}</p>
          </button>
        ))}
      </div>
      {/* Pagination */}
  ...
  return (
    <>
      ...
      >
        ...
        <span className="font-pretendard leading-[1.3] text-[#9c9c9c] tracking-[-0.24px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.common.list}</span>
      </button>
      {/* Title row */}
      <div
      ...
      >
        <p className="font-pretendard font-bold leading-[1.3] text-grayscale-900 tracking-[-1.56px]" style={{ fontSize: 54 }}>{n.title}</p>
        <p className="font-montserrat font-bold leading-none text-grayscale-600" style={{ fontSize: 18 }}>{n.date}</p>
      </div>
      {/* Content card */}
      <div
      ...
      >
        <div className="font-pretendard leading-[0] text-grayscale-900 whitespace-pre-wrap" style={{ fontSize: 20, letterSpacing: "-0.24px" }}>
    ...
    >
        ...
        {NEWS_CARDS.map((c) => (
          <div key={c.title} className="flex flex-1 flex-col gap-[60px] items-end justify-center">
            ...
            <div className="flex flex-col gap-[16px] items-center justify-center w-full">
              <p className="font-pretendard leading-[1.1] text-grayscale-900 tracking-[-0.36px] w-full" style={{ fontSize: 32, fontWeight: 800 }}>{c.title}</p>
              <div className="font-pretendard leading-[0] text-grayscale-600 w-full" style={{ fontSize: 20, letterSpacing: "-0.24px" }}>
                {c.body.map((line, i) => (
                  <p key={i} className="leading-[1.3]" style={{ marginBottom: 0 }}>{line}</p>
                ))}
              </div>
      ...
      <div className="flex flex-col gap-[60px] items-start justify-center w-full">
        ...
        <div className="flex flex-col gap-[30px] items-start w-full">
          <p className="font-pretendard leading-[1.3] text-grayscale-900 tracking-[-0.24px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.subpage5.newsForm.nameLabel}</p>
        ...
        {/* Phone */}
        <div className="flex flex-col gap-[30px] items-start w-full">
          <p className="font-pretendard leading-[1.3] text-grayscale-900 tracking-[-0.24px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.subpage5.newsForm.phoneLabel}</p>
          <div className="flex flex-col gap-[25px] items-start w-full">
            <input
              type="tel"
              value={form.phone}
        ...
        {/* Email */}
        <div className="flex flex-col gap-[30px] items-start w-full">
          <p className="font-pretendard leading-[1.3] text-grayscale-900 tracking-[-0.24px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.subpage5.newsForm.emailLabel}</p>
          <div className="flex flex-col gap-[25px] items-start w-full">
            <input
              type="email"
              value={form.email}
        ...
        <div className="flex flex-col gap-[40px] items-start w-full">
          <p className="font-pretendard leading-[1.3] text-grayscale-900 tracking-[-0.24px] w-full" style={{ fontSize: 20 }}>{t.subpage5.newsForm.interestsLabel}</p>
          <div className="flex gap-[80px] items-start">
            {INTEREST_OPTIONS.map((opt, i) => (
              ...
              >
                ...
                <span className="font-pretendard leading-[1.3] text-grayscale-900 tracking-[-0.24px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.subpage5.newsForm.interestOptions[i] || opt}</span>
              </button>
            ))}
          </div>
        </div>
      ...
      <div className="flex gap-[60px] items-center justify-end w-full">
        ...
        >
          ...
          <span className="font-pretendard leading-[1.3] text-grayscale-900 tracking-[-0.24px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.subpage5.newsForm.agreeLabel}</span>
        </button>
        <button
          type="button"
          onClick={onSubmit}
        ...
        >
          <span className="font-pretendard font-bold leading-normal text-grayscale-900 tracking-[-0.96px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.common.submit}</span>
        </button>
      </div>
    </div>
  );
...
function PCContact({
  ...
  return (
    <div className="absolute flex gap-[60px] items-start" style={{ left: 200, top: F(1387), width: 1534 }}>
      <div className={`font-pretendard leading-[0] text-grayscale-900 ${lang === "en" ? "" : "whitespace-nowrap"} shrink-0`} style={{ fontSize: lang === "en" ? 24 : 32, letterSpacing: "-0.72px" }}>
        {intro.map((line, i) => (
      ...
      <div className="flex flex-1 flex-col gap-[60px] items-end min-w-px">
        <div className="flex flex-col gap-[60px] items-start justify-center w-full">
          <div className="flex gap-[60px] items-start w-full">
            <div className="flex flex-1 flex-col gap-[30px] items-start min-w-px">
              <p className="font-pretendard leading-[1.3] text-grayscale-900 tracking-[-0.24px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.subpage5.contactForm.nameLabel}</p>
              <div className="flex flex-col gap-[25px] items-start w-full">
                <input
                  type="text"
                  value={form.name}
            ...
            <div className="flex flex-1 flex-col gap-[30px] items-start min-w-px">
              <p className="font-pretendard leading-[1.3] text-grayscale-900 tracking-[-0.24px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.subpage5.contactForm.emailLabel}</p>
              <div className="flex flex-col gap-[25px] items-start w-full">
                <input
                  type="email"
                  value={form.email}
          ...
          <div className="flex flex-col gap-[30px] items-start w-full">
            <p className="font-pretendard leading-[1.3] text-grayscale-900 tracking-[-0.24px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.subpage5.contactForm.messageLabel}</p>
            <div className="flex flex-col gap-[140px] items-start w-full">
              <textarea
                ...
                style={{ fontSize: 20, minHeight: 20 * 1.3 }}
              />
              <div className="h-px w-full bg-grayscale-900" />
            </div>
          </div>
        ...
        <button
          ...
          style={{ borderTopLeftRadius: 20, borderBottomRightRadius: 20, width: 224 }}
        >
          <span className="font-pretendard font-bold leading-normal text-grayscale-900 tracking-[-0.96px] whitespace-nowrap" style={{ fontSize: 20 }}>{t.common.send}</span>
        </button>
      </div>
    </div>
  );
      ...
      <div className="flex flex-col items-start font-pretendard font-bold w-screen -mx-[20px]">
        {NOTICES.map((n) => (
          ...
          >
            ...
            <p className="leading-normal text-grayscale-900 tracking-[-0.8px]" style={{ fontSize: 16, fontWeight: 700 }}>{n.title}</p>
          </button>
        ))}
      </div>
      {/* Pagination */}
...
function MobileNoticeDetail({ noticeId, onBack }: { noticeId: number; onBack: () => void }) {
  ...
  return (
    <div className="flex flex-col items-start pb-[39px] pt-[15px] w-screen -mx-[20px]">
      ...
      >
        <span className="block size-[24px]"><ArrowLeft size={24} /></span>
        <span className="font-pretendard font-bold leading-normal text-[#9c9c9c] tracking-[-0.8px]" style={{ fontSize: 16 }}>{t.common.list}</span>
      </button>
      {/* Title row */}
    ...
    <div className="flex flex-col gap-[46px] items-start w-full">
      <div className="flex flex-col gap-[32px] items-start w-full">
        ...
        <div className="flex flex-col gap-[20px] items-start w-full">
          <p className="font-pretendard leading-normal text-grayscale-900 tracking-[-0.8px] whitespace-nowrap" style={{ fontSize: 16 }}>{t.subpage5.newsForm.nameLabel}</p>
        ...
        {/* Phone */}
        <div className="flex flex-col gap-[20px] items-start w-full">
          <p className="font-pretendard leading-normal text-grayscale-900 tracking-[-0.8px] whitespace-nowrap" style={{ fontSize: 16 }}>{t.subpage5.newsForm.phoneLabel}</p>
          <div className="flex flex-col gap-[16px] items-start w-full">
            <input
              type="tel"
              value={form.phone}
        ...
        {/* Email */}
        <div className="flex flex-col gap-[20px] items-start w-full">
          <p className="font-pretendard leading-normal text-grayscale-900 tracking-[-0.8px] whitespace-nowrap" style={{ fontSize: 16 }}>{t.subpage5.newsForm.emailLabel}</p>
          <div className="flex flex-col gap-[16px] items-start w-full">
            <input
              type="email"
              value={form.email}
      ...
      <div className="flex flex-col gap-[24px] items-end justify-center w-full">
        ...
        >
          <Checkbox checked={agree} size={24} />
          <span className="font-pretendard leading-normal text-grayscale-900 tracking-[-0.8px]" style={{ fontSize: 16 }}>{t.subpage5.newsForm.agreeLabel}</span>
        </button>
        <button
          type="button"
          onClick={onSubmit}
        ...
        >
          <span className="font-pretendard font-bold leading-normal text-grayscale-900 tracking-[-0.8px] whitespace-nowrap" style={{ fontSize: 16 }}>{t.common.submit}</span>
        </button>
      </div>
      {/* 3 cards */}
      ...
      <div className="flex flex-col gap-[70px] items-end w-full">
        <div className="flex flex-col gap-[60px] items-start justify-center w-full">
          <div className="flex flex-col gap-[60px] items-start w-full">
            {/* Name */}
            <div className="flex flex-col gap-[20px] items-start w-full">
              <p className="font-pretendard leading-normal text-grayscale-900 tracking-[-0.8px] whitespace-nowrap" style={{ fontSize: 16 }}>{t.subpage5.contactForm.nameLabel}</p>
              <div className="flex flex-col gap-[16px] items-start w-full">
                <input
                  type="text"
                  value={form.name}
            ...
            {/* Email */}
            <div className="flex flex-col gap-[20px] items-start w-full">
              <p className="font-pretendard leading-normal text-grayscale-900 tracking-[-0.8px] whitespace-nowrap" style={{ fontSize: 16 }}>{t.subpage5.contactForm.emailLabel}</p>
              <div className="flex flex-col gap-[16px] items-start w-full">
                <input
                  type="email"
                  value={form.email}
          ...
          {/* Message */}
          <div className="flex flex-col gap-[20px] items-start w-full">
            <p className="font-pretendard leading-normal text-grayscale-900 tracking-[-0.8px] whitespace-nowrap" style={{ fontSize: 16 }}>{t.subpage5.contactForm.messageLabel}</p>
            <div className="flex flex-col gap-[140px] items-start w-full">
              <textarea
                value={form.message}
                onChange={(e) => setForm((f) => ({ ...f, message: e.target.value }))}
        ...
        <button
          ...
          style={{ borderTopLeftRadius: 20, borderBottomRightRadius: 20 }}
        >
          <span className="font-pretendard font-bold leading-normal text-grayscale-900 tracking-[-0.8px] whitespace-nowrap" style={{ fontSize: 16 }}>{t.common.send}</span>
        </button>
      </div>
    </div>
  );
