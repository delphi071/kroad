      ...
      >
        ...
        <div className="relative z-10 h-full w-full lg:hidden">
          ...
          >
            ...
            <span className="font-montserrat whitespace-nowrap text-[10px] font-bold leading-normal">SCROLL TO DISCOVER</span>
          </button>
        </div>
        ...
        <div className="hidden lg:block">
          <div className="absolute left-0 top-0 origin-top-left" style={{ width: 1920, height: 1080, transform: "scale(calc(100vw / 1920px))" }}>
            <div aria-hidden={collapsed} style={{ opacity: collapsed ? 0 : 1, pointerEvents: collapsed ? "none" : "auto", transition: "opacity 0.3s" }}>
              ...
              <button
                ...
                style={{ left: 1529, top: 582, width: 169, height: 49, background: "transparent", border: 0 }}
              />
            </div>
          ...
          {!collapsed && (
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/figma/hero-scroll-chevron.png" alt="" aria-hidden className="absolute" style={{ left: "50%", top: "calc(100% * 80 / 244)", transform: "translateX(-50%)", width: "calc(100vw * 32 / 1920)", height: "calc(100vw * 32 / 1920)" }} />
              <span className="font-montserrat absolute whitespace-nowrap text-white" style={{ left: "50%", top: "calc(100% * 160 / 244)", transform: "translateX(-50%)", fontSize: "calc(100vw * 15 / 1920)", lineHeight: 1.5, fontWeight: 500 }}>
                CLICK TO DISCOVER
              </span>
            </button>
          )}
