...
export default function Hero5Section() {
  ...
  return (
    <>
      ...
      >
        <Image src="/figma/hero5-bg.png" alt="" fill priority sizes="100vw" className="absolute inset-0 object-cover" />
        ...
        {/* MOBILE LAYOUT — "알리는" / "이야기" stacked centered */}
        ...
        <div className="hidden lg:block">
          <div className="absolute left-0 top-0 origin-top-left" style={{ width: 1920, height: 1080, transform: "scale(calc(100vw / 1920px))" }}>
            <div aria-hidden={collapsed} style={{ opacity: collapsed ? 0 : 1, pointerEvents: collapsed ? "none" : "auto", transition: "opacity 0.3s" }}>
              {/* Vector 4 (left, scaleY(-1)) — already on disk as hero5-vec-4.svg, but inline for parity */}
              <div className="absolute" style={{ left: -28, top: 304, width: 751, height: 175 }} aria-hidden>
                <div className="flex h-full w-full items-center justify-center" style={{ transform: "scaleY(-1)" }}>
                  <div className="absolute" style={{ inset: "0 -1.8% -7.71% 0" }}>
                    <svg preserveAspectRatio="none" width="100%" height="100%" viewBox="0 0 764.5 188.5" fill="none" style={{ overflow: "visible", display: "block" }} xmlns="http://www.w3.org/2000/svg">
                      <path d="M0 175H641A110 110 0 0 0 751 65V0" stroke="#0AC200" strokeWidth={32} vectorEffect="non-scaling-stroke" />
                    </svg>
                  </div>
                </div>
              </div>
              ...
              {/* Vector 5 (right) */}
              <div className="absolute" style={{ left: 1143, top: 616, width: 776, height: 143 }} aria-hidden>
                <div className="absolute" style={{ inset: "0 0 -9.44% -1.74%" }}>
                  <svg preserveAspectRatio="none" width="100%" height="100%" viewBox="0 0 789.5 156.5" fill="none" style={{ overflow: "visible", display: "block" }} xmlns="http://www.w3.org/2000/svg">
                    <path d="M789.5 143H123.5A110 110 0 0 1 13.5 33V0" stroke="#0AC200" strokeWidth={32} vectorEffect="non-scaling-stroke" />
                  </svg>
                </div>
              </div>

              {/* Headings */}
              <p className="font-suite text-primary absolute whitespace-nowrap" style={{ left: "calc(50% - 546px)", top: 457, fontSize: 201.5, lineHeight: 0.9, letterSpacing: "-10.075px", fontWeight: 900, margin: 0 }}>
                알리는
              </p>
              <p className="font-suite text-primary absolute whitespace-nowrap" style={{ left: "calc(50% + 41px)", top: 457, fontSize: 201.5, lineHeight: 0.9, letterSpacing: "-10.075px", fontWeight: 900, margin: 0 }}>
                이야기
              </p>
              ...
              <button
                ...
                style={{ left: 1529, top: 582, borderTopLeftRadius: 20, borderBottomRightRadius: 20 }}
              >
              ...
              {/* Subtitle */}
              <p className="font-montserrat absolute whitespace-nowrap text-white" style={{ left: 776, top: 659, fontSize: 30.395, lineHeight: 1.3, letterSpacing: "-0.6079px", fontWeight: 800 }}>
                News
              </p>
              <div className="font-pretendard absolute whitespace-nowrap text-white" style={{ left: 887, top: 666, fontSize: 20, lineHeight: 1.5, letterSpacing: "-0.2px", fontWeight: 500 }}>
                <p>새로운 길 이야기를 전합니다</p>
              </div>
            </div>
