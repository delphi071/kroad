...
const CARDS = [
  {
    ...
    imgW: 430,
    imgH: 430,
    imgLeft: "50%" as string | number,
    imgTop: "calc(50% - 82px)" as string | number,
  ...
  },
  {
    ...
    imgW: 393,
    imgH: 337,
    imgLeft: "calc(50% + 0.5px)" as string | number,
    imgTop: "calc(50% - 81.5px)" as string | number,
    imgTransform: "translate(-50%, -50%)",
  },
  {
    eng: "Connection",
    ...
    imgW: 581.77,
    imgH: 258,
    imgLeft: "calc(50% - 9.5px)" as string | number,
    imgTop: 329 as string | number,
